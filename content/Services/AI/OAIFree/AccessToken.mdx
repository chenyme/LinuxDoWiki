...
当你在官网登录 ChatGPT 之后，系统会为你自动发放一个许可令牌，这个令牌就是 Access Token。它是一种是会过期的动态令牌，相当于另一种登陆方式，但是安全性更高，目前 OpenAI 的 Access Token 有效期为10天。
...
- 前往 ChatGPT 官网对话页，登陆后键盘按 F12，在侧边栏中点击 `应用程序`
